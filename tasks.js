...
const TASKS = [
...

  {
    ...
    title: "Einen Termin kurzfristig verschieben",
    situation:
      "Sie müssen einen wichtigen beruflichen Termin kurzfristig verschieben und schreiben dazu eine E-Mail.",
    punkte: [
      "Teilen Sie höflich mit, dass Sie den Termin leider verschieben müssen.",
      "Nennen Sie kurz einen Grund dafür.",
      "Schlagen Sie zwei alternative Termine vor.",
      "Entschuldigen Sie sich für die Unannehmlichkeiten und bitten Sie um eine kurze Rückmeldung."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Formeller, höflicher Ton; klare zeitliche Angaben."
  },
  {
    id: "bskb1p-telc-k4-2",
    format: "TELC_B2_BERUF",
    ...
    register: "informell",
    handlungsfeld: "Gestaltung sozialer Kontakte am Arbeitsplatz",
    title: "Pünktlichkeit im Team ansprechen",
    situation:
      "Ein Kollege/eine Kollegin kommt öfter zu spät zu gemeinsamen Terminen. Sie schreiben ihr/ihm eine kurze, freundliche Nachricht dazu.",
    punkte: [
      "Sprechen Sie das Thema freundlich, aber klar an.",
      "Erklären Sie kurz, warum Ihnen Pünktlichkeit wichtig ist.",
      "Machen Sie einen Vorschlag, wie man Termine künftig besser koordinieren könnte.",
      "Bleiben Sie dabei kollegial und verständnisvoll."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Kollegialer, aber respektvoller Ton (du, aber am Arbeitsplatz)."
  },
  {
    ...
    title: "Eine falsche Lieferung reklamieren",
    situation:
      "Sie haben für Ihre Firma Büromaterial bestellt, aber eine falsche und teilweise beschädigte Lieferung erhalten. Sie schreiben deshalb eine E-Mail an den Lieferanten.",
    punkte: [
      "Beschreiben Sie kurz, was Sie bestellt haben und was stattdessen geliefert wurde.",
      "Erklären Sie, dass ein Teil der gelieferten Ware beschädigt ist.",
      "Fragen Sie nach einer schnellen Lösung (Umtausch oder Rücksendung).",
      "Bitten Sie um eine Rückmeldung bis zu einem bestimmten Datum."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Formeller, sachlicher Ton; klare Beschreibung des Problems und der gewünschten Lösung."
  },
  {
    id: "bskb1p-telc-k5-2",
    format: "TELC_B2_BERUF",
    ...
    kapitel: 5,
    register: "informell",
    handlungsfeld: "Austausch von Informationen",
    title: "Von den ersten Eindrücken im neuen Job erzählen",
    situation:
      "Sie haben vor Kurzem eine neue Stelle im Verkauf angefangen und schreiben einer guten Freundin/einem guten Freund darüber.",
    punkte: [
      "Erzählen Sie, wo Sie jetzt arbeiten und was Sie dort machen.",
      "Berichten Sie von einer positiven Erfahrung aus der ersten Zeit.",
      "Erwähnen Sie auch etwas, das für Sie noch ungewohnt ist.",
      "Fragen Sie, wie es Ihrer Freundin/Ihrem Freund gerade geht."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Lockerer, persönlicher Ton (du); ruhig auch eigene Gefühle/Eindrücke einbauen."
  },
  {
    id: "bskb1p-telc-k6-1",
    format: "TELC_B2_BERUF",
    ...
    kapitel: 6,
    register: "formell",
    handlungsfeld: "Umgang mit Dissens und Konflikten",
    title: "Eine mangelhafte Reparatur reklamieren",
    situation:
      "Ein Handwerksbetrieb hat bei Ihnen eine Reparatur durchgeführt, die aber nicht richtig funktioniert. Sie schreiben eine Beschwerde-E-Mail an die Firma.",
    punkte: [
      "Beschreiben Sie kurz, welche Arbeit ausgeführt wurde und was das Problem ist.",
      "Erklären Sie, warum Sie mit dem Ergebnis nicht zufrieden sind.",
      "Fordern Sie eine kostenlose Nachbesserung.",
      "Setzen Sie eine Frist für die Rückmeldung."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Formeller, sachlicher Ton; klare Beschreibung des Mangels und der erwarteten Lösung."
  },
  {
    id: "bskb1p-telc-k6-2",
    format: "TELC_B2_BERUF",
    ...
    register: "informell",
    handlungsfeld: "Austausch von Informationen",
    title: "Um Empfehlung für einen zuverlässigen Anbieter bitten",
    situation:
      "Sie suchen einen zuverlässigen Handwerker oder Internetanbieter und schreiben einer guten Freundin/einem guten Freund, um nach einer Empfehlung zu fragen.",
    punkte: [
      "Erklären Sie kurz, wofür Sie jemanden brauchen.",
      "Fragen Sie, ob sie/er gute Erfahrungen mit einem Anbieter gemacht hat.",
      "Erwähnen Sie, worauf Ihnen dabei besonders wichtig ist (z. B. Preis, Zuverlässigkeit).",
      "Bedanken Sie sich im Voraus für den Tipp."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Lockerer, persönlicher Ton (du)."
  },
  {
    id: "bskb1p-telc-k7-1",
    format: "TELC_B2_BERUF",
    ...
    register: "formell",
    handlungsfeld: "Berufliche Aus-/Fort-/Weiterbildung",
    title: "Um Teilnahme an einer Digitalisierungs-Fortbildung bitten",
    situation:
      "Ihr Betrieb bietet eine Fortbildung zum Thema Digitalisierung und neue Software an. Sie schreiben eine E-Mail an Ihre Vorgesetzte/Ihren Vorgesetzten und bitten um die Teilnahme.",
    punkte: [
      "Erklären Sie, warum Sie an der Fortbildung teilnehmen möchten.",
      "Beschreiben Sie kurz, welche Kenntnisse Ihnen dafür bisher fehlen.",
      "Erklären Sie, wie die Fortbildung Ihrer Arbeit im Betrieb nützen könnte.",
      "Fragen Sie, bis wann Sie sich anmelden müssen."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Formeller, sachlicher Ton; klarer Bezug zwischen der Fortbildung und dem eigenen Arbeitsplatz."
  },
  {
    id: "bskb1p-telc-k7-2",
    format: "TELC_B2_BERUF",
    ...
    title: "Über die Zukunft der Arbeit schreiben",
    situation:
      "Eine gute Freundin/ein guter Freund hat Sie gefragt, wie Sie über neue Technik und Digitalisierung am Arbeitsplatz denken. Sie schreiben eine Nachricht und erzählen von Ihrer Meinung.",
    punkte: [
      "Erzählen Sie, welche digitalen Veränderungen es an Ihrem Arbeitsplatz gibt.",
      "Sagen Sie, was Sie daran gut finden.",
      "Sagen Sie, was Ihnen dabei auch Sorgen macht.",
      "Schreiben Sie, wie Sie sich die Arbeit in Zukunft vorstellen."
    ],
    minWords: 120,
    maxWords: 180,
    hinweis: "Lockerer, persönlicher Ton (du); eigene Meinung mit Beispielen begründen."
  },
